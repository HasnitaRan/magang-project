...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    //menu data elemen
    Route::resource('/dimensi/{dimensi_id}/elemen', ElemenController::class)->except(['create', 'edit']);
    Route::get('/dimensi/{dimensi_id}/elemens', [ElemenController::class, 'serversideTable']); // get data
