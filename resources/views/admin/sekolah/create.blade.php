        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="mb-0">Add Data Sekolah</h1>
                    <hr />

                    <p><a href="" class="btn btn-primary">Go Back</a></p>
                    
                    <form action="{{ route('admin.sekolah.save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="text" name="nip_kepsek" class="form-control" placeholder="NIP Kepsek">
                                @error('nip_kepsek')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="file" name="logo_sekolah" class="form-control" placeholder="Logo Sekolah">
                                @error('logo_sekolah')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="text" name="kepala_sekolah" class="form-control" placeholder="Kepala Sekolah">
